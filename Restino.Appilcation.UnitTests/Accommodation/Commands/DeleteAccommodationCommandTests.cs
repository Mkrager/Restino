...
namespace Restino.Appilcation.UnitTests.Accommodation.Commands
{
    public class DeleteAccommodationCommandTests
    {
        ...
        {
            var handler = new DeleteAccommodationCommandHandler(_mapper, _mockAccommodationRepository.Object, _mockAuthenticationService.Object);
            await handler.Handle(new DeleteAccommodationCommand() { AccommodationsId = Guid.Parse("2a4ab6df-66b8-46f7-8198-c94332964002") }, CancellationToken.None);
