...
namespace Restino.Application.Features.Accommodation.Queries.GetUserAccommodationList
{
    public class GetUserAccommodationListQueryHandler : IRequestHandler
        <GetUserAccommodationListQuery, List<UserAccommodationList>>
    {
        ...
        public async Task<List<UserAccommodationList>> Handle(GetUserAccommodationListQuery request, CancellationToken cancellationToken)
        {
            var accommodationsUser = await _accommodationRepository.ListUserAccommodations(request.UserId);
            var accommodationUserDetailsDto = _mapper.Map<List<UserAccommodationList>>(accommodationsUser);
